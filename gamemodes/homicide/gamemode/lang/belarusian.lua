...
pt.tips = {
	"Сюрыкен - гэта не смяротная зброя. Ён карысны для атручвання і для нанясення страт тым, хто знаходзіцца па-за дасяжнасцю.", -- "Вашы заслугі (забойствы, перадачы і г.д.) захоўваюцца ў базе дадзеных сервера і выкарыстоўваюцца пры разліку вашага навыку (SK)..", -- "Вашы недахопы (смерці, камандныя паразы і г.д.) захоўваюцца ў базе дадзеных сервера і выкарыстоўваюцца пры разліку вашага навыку (SK)..", -- "Агульны час, праведзены вамі ў жывых падчас гульні, захоўваецца ў базе дадзеных сервера і выкарыстоўваецца пры разліку вашага досведу. (XP)..",
