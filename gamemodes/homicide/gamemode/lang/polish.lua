...
pt.startHelpBystander = {"Morderca jest na wolności", "Nie daj się zabić"}
pt.startHelpGunTitle = "Jesteś świadkiem"
pt.startHelpGunSubtitle = "z sekretną bronią"
pt.startHelpGun = {"Morderca jest na wolności", "Znajdź go i zabij"}
pt.startHelpMurdererTitle = "Jesteś mordercą"
pt.startHelpMurderer = {"Zabij wszystkich", "Nie daj się złapać"}
