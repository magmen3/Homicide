...
pt.startHelpBystander = {"There is a murderer on the loose", "Don't get killed", "Attacking others will cause you to lose your innocence"}
pt.startHelpGunTitle = "You are a bystander"
pt.startHelpGunSubtitle = "with a lawful concealed firearm"
pt.startHelpGun = {"There is a murderer on the loose", "Find and kill him/her", "Do not kill innocents unless they are attacking other innocents"}
...
pt.startHelpInnocent = {"There is a greedy, murderous traitor in the group", "Be wary"}
pt.startHelpZombieTitle = "You are the alpha zombie"
pt.startHelpZombie = {"Lead your zombie hordes", "Consume the brains of the living"}
pt.startHelpTraitorTitle = "You are the traitor"
pt.startHelpTraitor = {"Kill everyone and take their stuff", "Don't get caught"}
pt.startHelpBigGunSubtitle = "with a large weapon"
pt.startHelpSurvgun = {"Kill the alpha zombie, or", "kill all the other zombies, or", "hide until the army arrives"}
pt.startHelpIngun = {"Find and kill the traitor", "Defend the innocent"}
