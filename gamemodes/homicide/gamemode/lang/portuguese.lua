...
pt.startHelpBystander = {"Porém temos um assassino a solta", "Não seja morto"}
pt.startHelpGunTitle = "Você é um Inocente"
pt.startHelpGunSubtitle = "com uma arma secreta"
pt.startHelpGun = {"Porém temos um assassino a solta", "Ache e elimine ele"}
pt.startHelpMurdererTitle = "Você é o Assassino"
pt.startHelpMurderer = {"Mate todos eles", "Não seja pego"}
